...
const Footer = () => {
  return (
    <div className='bg-gray-900'>
        <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:pd-24 lg:px-4'>
            <div className='grid mb-8 lg:grid-cols-6'>
                <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                    ...
                    <div>
                        ...
                        <ul className='mt-2 space-y-2'>
                            ...
                            <li><a href="/" className="text-gray-500 transition-colors duration-300 hover:text-orange-500">Non-profit</a></li>
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <form className='flex flex-col md:flex-row mt-4'>
                            <input type="email" name='email' id="ema" className='flex-grow w-full h-12 px-4 mb-4 transition duration-200 bg-white border border-gray-300 rounded-sm aspect-auto md:mr-2 md:mb-0 focus:border-purple-400 focus:outline-none' />
                        ...
                        <p className='text-sm text-gray-500 mt-4'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci sit, ea atque est sunt pariatur, deserunt provident, architecto minima saepe commodi molestias nesciunt. Blanditiis tempora repellat laborum rerum soluta asperiores harum doloribus optio beatae.</p>
                </div>
            </div>
            <div className='flex flex-col justify-between pt-5 pb-10 border-tborder-gray-800 sm:flex-row'>
                <p className='text-sm text-gray-500'>© Copyright 2023 | All right resereved</p>
                <div className='flex items-center mt-4 space-x-4 sm:mt-0'>
                    <a href="/" className='text-gray-500 transition-all duriation-300 hover:text-orange-500'><FaTwitter size={25}/></a>
                    <a href="/" className='text-gray-500 transition-all duriation-300 hover:text-orange-500'><FaInstagram size={25}/></a>
                    <a href="/" className='text-gray-500 transition-all duriation-300 hover:text-orange-500'><FaFacebook size={25}/></a>
                </div>
            </div>
        </div>
    </div>
